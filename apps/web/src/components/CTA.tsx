  ...
  return (
    <section className="relative isolate overflow-hidden bg-white">
      ...
      <div className="mx-auto max-w-6xl px-6 py-20 sm:py-24 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl border border-white/40 bg-white/40 p-10 text-center shadow-2xl backdrop-blur-2xl sm:p-14">
          {/* Subtle logo glow behind text */}
          <div aria-hidden className="pointer-events-none absolute inset-0">
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-20">
              <div className="flex h-20 w-20 items-center justify-center rounded-2xl border border-gray-200 bg-white shadow-sm">
                <Image src="/image.png" alt="" width={28} height={28} className="h-6 w-auto" />
              </div>
            </div>
          </div>
