          ...
          <div className="rounded-3xl border border-white/40 bg-white/40 p-6 shadow-xl backdrop-blur-xl">
            ...
            <div className="flex items-center gap-2 rounded-xl border border-gray-200 bg-white/70 px-4 py-3 shadow-sm">
              ...
              <input
                ...
                className="w-full bg-transparent text-sm text-gray-900 placeholder-gray-400 outline-none caret-[#f1998d]"
              />
            </div>
            ...
            <div className="mt-5 space-y-3">
              {augmentedResults.map((r) => (
                <div
                  key={r.title}
                  className={`group flex items-center justify-between rounded-xl border border-gray-200 bg-white/80 px-4 py-3 shadow-sm ring-1 ring-transparent transition-all hover:-translate-y-0.5 hover:shadow-md transition-opacity duration-300 ease-in-out ${r.isMatch ? 'opacity-100' : 'opacity-30'}`}
                >
                  <div>
